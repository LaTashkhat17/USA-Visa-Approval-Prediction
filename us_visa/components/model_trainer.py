...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            metric_artifact = ClassificationMetricArtifact(f1_score=f1, accuracy_score=accuracy, precision_score=precision, recall_score=recall)
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            preprocessing_obj = load_object(file_path=self.data_transformation_artifact.preprocessing_object_path)
            ...
            model_trainer_artifact = ModelTrainerArtifact(
                ...
                training_metric_artifact=metric_artifact,
                is_trained=True,
